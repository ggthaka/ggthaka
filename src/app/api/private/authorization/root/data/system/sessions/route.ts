import { getSession, getSessions, getUser } from '@library/handlers';
import {
  cookiePolicy,
  originPolicy,
  rolePolicy,
...
export async function GET(
  ...
  try {
    ...
    const sessions = await getSessions({ page, limit, search, filters });
    if (!sessions.ok) {
    ...
    return NextResponse.json(
      { ok: true, data: sessions.data, meta: sessions.meta },
